(function(h, e, b, i, c, g, j) {/* ! Jssor */
	...
	var d = h.$JssorEasing$ = {
		...
		$EaseInOutBounce : function(a) {
			return a < 1 / 2 ? d.$EaseInBounce(a * 2) * .5 : d
	...
	var a = new function() {
		...
		function v(i) {
			if (!s) {
				s = -1;
				if (tb == "Microsoft Internet Explorer" && !!h.attachEvent
						&& !!h.ActiveXObject) {
					...
					var d = k.indexOf("Firefox"), b = k.indexOf("Safari"), g = k
							.indexOf("Chrome"), c = k.indexOf("AppleWebKit");
					if (d >= 0) {
						s = fb;
						l = n(k.substring(d + 8))
					} else if (b >= 0) {
		...
		function zb(b, a, c) {
			if (bb < 9) {
				var e = b.style.filter, h = new RegExp(
		...
		f.$Delay = vb;
		function W(a) {
			a.constructor === W.caller && a.ad
					&& a.ad.apply(a, W.caller.arguments)
		}
		f.ad = W;
		f.Z = function(a) {
			if (f.fd(a))
		...
		function ab(e, a) {
			...
			if (M()) {
				...
				zb(e, !d && c == 1 ? i : l, f.se(l, a.$OriginalWidth,
						a.$OriginalHeight))
			} else {
				var g = t(e);
				if (g) {
		...
		f.se = function(d, c, a) {
			var e = F.Lb(d, y(-c / 2, -a / 2)), f = F.Lb(d, y(c / 2, -a / 2)), g = F
					.Lb(d, y(c / 2, a / 2)), h = F.Lb(d, y(-c / 2, a / 2));
			return y(b.min(e.x, f.x, g.x, h.x) + c / 2, b.min(e.y, f.y, g.y,
					h.y)
					+ a / 2)
		};
		f.vd = function(l, g, t, r, u, w, j) {
			...
			if (g.$Clip && j.$Move) {
				var k = c.$Clip.xb, o = (k.$Top || 0) + (k.$Bottom || 0), n = (k.$Left || 0)
						+ (k.$Right || 0);
				c.$Left = (c.$Left || 0) + n;
				c.$Top = (c.$Top || 0) + o;
				c.$Clip.$Left -= n;
			...
			if (c.$Clip && a.Se() && !c.$Clip.$Top && !c.$Clip.$Left
	...
	function k(o, z, k, R, P, K) {
		...
		var t = h.requestAnimationFrame || h.webkitRequestAnimationFrame
	...
	h.$JssorSlideshowRunner$ = function(o, s, q, t, y) {
		...
		function p(A, i, d, v, n, l) {
			var y = this, t, u = {}, j = {}, m = [], f, e, r, p = d.$ChessMode.$Column || 0, q = d.$ChessMode.$Row || 0, h = d
					.yd(n, l), o = B(d), C = o.length - 1, s = d.$Duration
					+ d.$Delay * C, w = v + s, k = d.$SlideOut, x;
			w += 50;
			function B(a) {
				var b = a.$Formation(a);
	...
	var f = h.$JssorSlider$ = function(q, fc) {
		...
		function Zb(g, f) {
			var e = w > 0 ? w : ib, c = Bb * f * (e & 1), d = Cb * f
					* (e >> 1 & 1);
			c = b.round(c);
			d = b.round(d);
			a.C(g, c);
		...
		function Yb(b, d) {
			b = a.kd(b);
			var k = a.rc(b);
			if (!K && !a.u(k, "nodrag") && vc()
					&& (!d || b.touches.length == 1)) {
				B = c;
				Ab = g;
				T = i;
		...
		var ib = p.$PlayOrientation & 3, Wb = (p.$PlayOrientation & 4) / -4
				|| 1, fb = p.$SlideshowOptions, L = a.n({
			$Class : o,
			$PlayInMode : 1,
			$PlayOutMode : 1
		}, p.$CaptionSliderOptions), rb = p.$BulletNavigatorOptions, V = p.$ArrowNavigatorOptions, bb = p.$ThumbnailNavigatorOptions, S = !p.$UISearchMode, x, u = a
				.A(q, "slides", S), db = a.A(q, "loading", S) || a.ab(e), Jb = a
				.A(q, "navigator", S), cc = a.A(q, "arrowleft", S), ac = a.A(q,
				"arrowright", S), Hb = a.A(q, "thumbnavigator", S), nc = a.k(u), mc = a
				.l(u), R, U = [], wc = a.P(u);
		a.e(wc, function(b) {
		...
		var r = -1, yb, ub, s = U.length, J = p.$SlideWidth || nc, I = p.$SlideHeight
				|| mc, Vb = p.$SlideSpacing, Bb = J + Vb, Cb = I + Vb, bc = ib & 1 ? Bb
				: Cb, v = b.min(p.$DisplayPieces, s), jb, w, K, Ab, O = [], Pb, Rb, Nb, dc, Ec, Q, G = p.$PauseOnHover, pc = p.$AutoPlayInterval, Ub = p.$SlideDuration, sb, eb, hb, Qb = v < s, D = Qb ? p.$Loop
				: 0, X, M, H = 1, P, B, T, vb = 0, wb = 0, F, cb, gb, Eb, y, Z, z, Sb = new rc, Y;
		Q = p.$AutoPlay;
		n.Sb = fc;
		jc();
		...
		f.fc = function(D) {
			if (!w) {
				...
				for (var f = 0; f < t; f++) {
					...
					e.$ActionMode & 2
							&& a.c(g, "mouseover", a.Ob(a.L(i, v, f), g));
					A[f] = a.Mb(g)
				}
				w = c
			}
	...
	h.$JssorThumbnailNavigator$ = function(k, B) {
		...
		function A(l, f) {
			...
			function h() {
				if (!s.$LastDragSucceded()) {
					var a = e - f % e, b = s.sd((f + a) / e - 1), c = b * e + e
							- a;
					i.j(m.Ub, c)
				}
			}
		...
		i.fc = function(F, D) {
			if (!w) {
				...
				p = -1;
				o = b.min(o, D.length);
				var i = d.$Orientation & 1, m = u + (u + q) * (e - 1) * (1 - i), l = t
						+ (t + r) * (e - 1) * i, B = m + (m + q) * (o - 1) * i, n = l
						+ (l + r) * (o - 1) * (1 - i);
				a.D(h, "absolute");
				a.bb(h, "hidden");
				...
				var j = [];
				a.e(D, function(l, f) {
					var g = new A(l, f), d = g.Jb, c = b.floor(f / e), k = f
							% e;
					a.C(d, (u + q) * k * (1 - i));
					a.z(d, (t + r) * k * i);
					if (!j[c]) {
	...
	h.$JssorCaptionSlider$ = function(p, h, f) {
		...
		function m(w, c, z) {
			var g = {
				...
				$During : c.$During,
				$Reverse : f && !z
			}, m = w, r = a.zb(w), l = a.k(m), j = a.l(m), y = a.k(r), x = a
					.l(r), h = {}, e = {}, i = c.$ScaleClip || 1;
			if (c.$Opacity)
			...
			if (c.$Zoom || c.$Rotate) {
				...
				var s = {
					...
					$Bottom : j,
					$Left : 0
				}, v = a.n({}, s), d = v.xb = {}, u = c.$Clip & 4, p = c.$Clip & 8, t = c.$Clip & 1, q = c.$Clip & 2;
				if (u && p) {
					d.$Top = j / 2 * i;
					d.$Bottom = -d.$Top
				} else if (u)
